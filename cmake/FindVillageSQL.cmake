...
if(VillageSQL_BUILD_DIR AND NOT _villagesql_found)
  # Look for staged SDK in build directory (directories only, not .tar.gz archives)
  file(GLOB _sdk_dirs_all "${VillageSQL_BUILD_DIR}/villagesql-extension-sdk-*")
  set(_sdk_dirs "")
  foreach(_candidate ${_sdk_dirs_all})
    if(IS_DIRECTORY "${_candidate}")
      list(APPEND _sdk_dirs "${_candidate}")
    endif()
  endforeach()
  unset(_sdk_dirs_all)
  if(_sdk_dirs)
    ...
    list(GET _sdk_dirs ${_sdk_last} _sdk_dir)
